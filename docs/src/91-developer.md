...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/tmigot/NonSmoothDynamics.jl
   ```
...
- After that runs, the [stable docs](https://tmigot.github.io/NonSmoothDynamics.jl/stable) should be updated. Check them and look for the version number.
